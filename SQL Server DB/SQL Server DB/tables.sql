...
CREATE TABLE CATE_DE_CARRERA(
	id_carrera INT NOT NULL,
	Nombre_Cate VARCHAR(20) NOT NULL,
	PRIMARY KEY (id_carrera, Nombre_Cate)
);


USE straviadb
ALTER TABLE CATEGORIAS DROP CONSTRAINT CATEGORIAS_CARRERA_FK
ALTER TABLE CATEGORIAS DROP COLUMN id_carrera
